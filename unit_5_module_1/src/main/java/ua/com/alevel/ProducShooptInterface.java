...
public class ProducShooptInterface {
    ...
    private static void menu() {
        ...
        System.out.println("3. If you want find product, please enter name - 3");
        System.out.println("4. If you want find shoop, please enter name - 4");
        ...
        System.out.println("13. If you want close application, please enter - 13");
        System.out.println();
    }

    private static void crud(BufferedReader reader, String select) throws IOException {
        switch (select) {
            case "1" : createProduct(reader); break;
            case "2" : createShoop(reader); break;
            case "3" : findProduct(reader); break;
            case "4" : findShoop(reader); break;
